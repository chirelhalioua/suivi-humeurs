...
const fetchUserProfile = async () => {
  ...
  try {
    ...
    const response = await axios.get(' https://suivi-humeurs.onrender.com/api/auth/profile', {
      headers: {
...
const deleteProfile = async () => {
  ...
  try {
    ...
    const response = await axios.delete('https://suivi-humeurs.onrender.com/api/auth/profile', {
  headers: {
